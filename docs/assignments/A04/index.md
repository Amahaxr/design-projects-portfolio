...
Before creating the model, I set up global variables in SolidWorks using the dimensions calculated for Feature 1 and Feature 2. This allowed the dimensions of the model to be controlled parametrically.

![Part 11A Knowns and Unknowns](part11a.png)

I then created the main section of the motor mount using the calculated dimensions and extruded the sketch to the required thickness.

![Part 12A Knowns and Unknowns](part12a.png)

![Part 13A Knowns and Unknowns](part13a.png)

Next, I added the second feature to create the basic L-shaped motor mount, The two features were combined into one solid body.
